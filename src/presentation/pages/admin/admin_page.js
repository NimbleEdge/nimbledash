...
//   const data = {
//     headers: [{text: 'Models'}, {text: 'Models'}, {text: 'Models'}],
//     body: [
//       [{text: 'Row 11', clickable: true, Component: ({text}) => <div>{text}</div>}, {text: 'Row 11', clickable: true, Component: ({text}) => <div>{text}</div>}, {text: 'Row 11', clickable: true, Component: ({text}) => <div>{text}</div>}],
//       [{text: 'Row 11', clickable: true, Component: ({text}) => <div>{text}</div>}, {text: 'Row 11', Component: ({text}) => <div>{text}</div>}, {text: 'Row 11', Component: ({text}) => <div>{text}</div>}]
//     ]
//   }
